 ...
 * @property string     $product_story
 * @property string     $story_video
 * @property string     $story_youtubelink
 * @property string     $story_image_one
 * @property string     $story_image_two
 * @property string     $story_image_three
 * @property string     $story_image_four
 */
class ProductsOne extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'pu_products_one';
     ...
     */
    protected $casts = [
        'products_id' => 'int', 'meta_title' => 'string', 'meta_keyword' => 'string', 'meta_description' => 'string', 'ebay_title' => 'string', 'ebay_size' => 'string', 'ebay_desc' => 'string', 'skunew' => 'string', 'UPCnew' => 'string', 'extra_images' => 'string', 'youtubelink' => 'string', 'wish_update_date' => 'timestamp', 'newarrival_update_date' => 'timestamp', 'update_stock_datetime' => 'timestamp', 'admin_email' => 'string', 'admin_count' => 'int', 'is_admin_added_date' => 'timestamp', 'private_code' => 'string', 'point_multiplier' => 'int', 'alternate_UPC' => 'string', 'alternate_cosmo_sku' => 'string', 'alternate_nandansons_sku' => 'string', 'alternate_perfumeworldwide_sku' => 'string', 'alternate_pca_sku' => 'string', 'related_item' => 'string', 'product_story' => 'string', 'story_video' => 'string', 'story_youtubelink' => 'string', 'story_image_one' => 'string', 'story_image_two' => 'string', 'story_image_three' => 'string', 'story_image_four' => 'string'
    ];
     ...
     */
    protected $dates = [
        'wish_update_date', 'newarrival_update_date', 'update_stock_datetime', 'is_admin_added_date'
    ];
