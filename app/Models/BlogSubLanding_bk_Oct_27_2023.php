...
class BlogSubLanding extends Model
{
     ...
     */
    protected $fillable = [
        'main_blogid','blog_section_id', 'main_banner_img', 'banner_link', 'banner_title', 'banner_description', 'banner_link_title', 'rank', 'status','author_designation','author_image','meta_title','meta_keywords','meta_description'
    ];
